interface TentacleMarkProps {
  className?: string;
  title?: string;
}

/**
 * Apocrypha brand mark — tentacle strike, no background.
 * Uses currentColor so the parent's text color drives the fill.
 */
export function TentacleMark({ className, title }: TentacleMarkProps) {
  return (
    <svg
